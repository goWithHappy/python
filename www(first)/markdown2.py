...
if sys.version_info[:2] < (2,4):
    from www.sets import Set as set
...
class Markdown(object):
    ...
    def _get_emacs_vars(self, text):
        ...
        http://www(first).gnu.org/software/emacs/manual/html_node/emacs/Specifying-File-Variables.html#Specifying-File-Variables
        """
        emacs_vars = {}
        SIZE = pow(2, 13) # 8kB
    ...
    _sorta_html_tokenize_re = re.compile(r"""
        (
            ...
            \s*/?>
            |
            # auto-link (e.g., <http://www(first).activestate.com/>)
            <\w+[^>]*>
            |
            <!--.*?-->      # comment
            |
